...
This CLI tool manages access assignments across AWS, Azure, and Google Cloud Platform
...
def create_sso_assignments(
    ...
    Args:
        ...
        auto_approve (bool, optional): Flag to enable auto-approval mode.
            When True, changes are executed automatically.
            When False, changes are only displayed (plan mode).
            Defaults to False.
...
def create_argument_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Multi-Cloud Access Management Tool - Infrastructure-as-code access management for AWS, Azure, and Google Cloud Platform",
        prog="sso-manager",
    )
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="sso-manager - Multi-Cloud Access Management Tool\nFor version info, see: https://github.com/islamelkadi/sso-entitlements-manager/releases",
    )
...
def main():
    ...
    Implements multi-cloud access management with plan/apply workflow
