...
def lambda_handler(event: EventBridgeEvent, context: LambdaContext):  # pylint: disable=W0613
    ...
    AwsAccessResolver(MANIFEST_SCHEMA_DEFINITION_FILEPATH, manifest_file_local_path)

    return Response(status_code=HTTPStatus.OK.value, content_type=content_types.APPLICATION_JSON)
